...
export const optimizationResultSample: OptimizationResult = {
  ...
  correlation: {
    tickers: ["AAPL", "MSFT", "NVDA", "JPM", "XOM"],
    matrix: [
      [1, 0.726496, 0.491453, 0.470085, 0.231481],
      [0.726496, 1, 0.465976, 0.443787, 0.216346],
      [0.491453, 0.465976, 1, 0.310651, 0.15024],
      [0.470085, 0.443787, 0.310651, 1, 0.264423],
      [0.231481, 0.216346, 0.15024, 0.264423, 1],
    ],
  },
  orp: {
    weights: {
